...
-- create circuit table from CSV files
...
-- create races table from CSV files
...
--create constructors table from Json files
...
--create drivers table from Json files
...
--create results table from Json files
...
--create pit_stops table from Json files
